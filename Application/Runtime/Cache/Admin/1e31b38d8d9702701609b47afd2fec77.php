                ...
                <div class="result-content">
                    <table class="result-tab" width="100%">
                        ...
                        <?php if(is_array($cateres)): $i = 0; $__LIST__ = $cateres;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                            ...
                            <td title="<?php echo ($vo["catename"]); ?>"><a target="_blank" href="#" title="发哥经典"><?php echo ($vo["catename"]); ?></a>
                            </td>
                            <td>
                                <a class="link-update" href="/index.php/admin/cate/edit/id/<?php echo ($vo["id"]); ?>">修改</a>
                                <a class="link-del" onclick="return confirm('确定删除吗？');" href="/index.php/admin/cate/del/id/<?php echo ($vo["id"]); ?>">删除</a>
                            </td>
