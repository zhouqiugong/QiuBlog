...
<div class="container clearfix">
    ...
    <div class="main-wrap">
        ...
        <div class="result-wrap">
            <form name="myform" id="myform" action="/index.php/admin/admin/sort" method="post">
                ...
                <div class="result-content">
                    <table class="result-tab" width="100%">
                        ...
                        <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                            ...
                            <td>
                                <a class="link-update" href="/index.php/admin/admin/edit/id/<?php echo ($vo["id"]); ?>">修改</a>
                                <?php if($vo['id'] != 1): ?><a class="link-del" onclick="return confirm('确定删除吗？');" href="/index.php/admin/admin/del/id/<?php echo ($vo["id"]); ?>">删除</a><?php endif; ?>
                            </td>
